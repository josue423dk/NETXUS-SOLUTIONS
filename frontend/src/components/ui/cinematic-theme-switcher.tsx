  ...
  if (!mounted) {
    return (
      <div className="relative inline-block">
        <div className="relative flex h-9 w-[58px] items-center rounded-full bg-gray-200" />
      </div>
    );
  }
  ...
  return (
    <div className="relative inline-block">
      ...
      <motion.button
        ...
        className="relative flex h-9 w-[58px] items-center rounded-full p-[5px] transition-all duration-300 focus:outline-none"
        style={{
          background: isDark
          ...
          boxShadow: isDark
            ? `
              ...
              inset -3px -3px 6px rgba(71, 85, 105, 0.4),
            ...
            : `
              ...
              inset 4px 4px 8px rgba(100, 116, 139, 0.3),
